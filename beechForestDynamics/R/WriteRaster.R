...
#' @param rst_fn_names enth?lt Liste von gestackten Tiffs von 1 bis 12
#'
...
#'substr(Datei die reingegeben wird, Startposition, Endposition) w?hlt Tiffs von 1. bis 12. Position in der Liste aus
...
WriteRaster<- function(rst_scl, substr1, substr2, substr3){
  for (i in substr1){
    for (a in substr2){
      ...
      #Erstellen von rst_fn_names: enth?lt rst_scl (gestackte Tiffs) von der 1. bis zur 12. Position der Liste
